...
# This file was *autogenerated* from the file blink128.sage
from sage.all_cmdline import *   # import sage library

_sage_const_128 = Integer(128); _sage_const_1 = Integer(1); _sage_const_6 = Integer(6)
...
blink = BLINK_CVL(n=_sage_const_128 ,t=_sage_const_128 , first_round=_sage_const_1 , last_round=_sage_const_6 )
blink.analyse(model_options)
blink.generate_report(model_options)
